                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('company.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            @method('PATCH')
                            @if ($data->logo)
                                <img src="{{ asset('storage/' . $data->logo) }}" alt="Company Logo"
                            ...
                            <div class="m-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                    value="{{ old('name', $data->name) }}" placeholder="Enter company name">
                            </div>
                            ...
                            <div class="m-3">
                                ...
                                <input type="url" class="form-control" id="website" name="website"
                                    value="{{ old('website', $data->website) }}" placeholder="Enter website URL">
                            </div>
